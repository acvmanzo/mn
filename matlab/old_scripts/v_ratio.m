...
% Creates the vector 'control' containing the data from the control
% ROI.
control = A(:,control_i);
...
ratio_traces = scaled_traces./repmat(control, 1, n_traces);
...
% (only in the frames after 'stim_frame'),
...
set(gca,'FontSize',7)
legend(num2str([roi_is control_i]'), 'Orientation', 'horizontal', 'Location', 'SouthOutside')
...
if s == 1, 
    ...
    % Saves files
    w = fullfile('c:\Users\Andrea\Documents\Lab\762\results',filename);
    mkdir(w);
    cd(w);
    ...
    x = fullfile('c:\Users\Andrea\Documents\Lab\762\results\summary\maxima',filenamedat);
    save(x,'maxima','-ascii');
    ...
    z = fullfile('c:\Users\Andrea\Documents\Lab\762\results\summary\avg_max_3frames',filenamedatavg);
    ...
    y = fullfile('c:\Users\Andrea\Documents\Lab\762\results\summary\ratioplots',filename);
    saveas(3,[y '_ratio.jpg'],'jpg');

    %Saves .jpg of the traces plot to the indicated folder.
    y = fullfile('c:\Users\Andrea\Documents\Lab\762\results\summary\traces',filename);
    saveas(1,[y 'traces.jpg'],'jpg');
