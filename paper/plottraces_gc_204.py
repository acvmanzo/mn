...
MOVIES = {
'2011-1107_112204_gc30_C_1_Wd_mc': ['Water', W, 'k'], 
'2012-0131_112204_gc30_I_3_Wdt_mc': ['Water (wd)', V, 'k'],
'2011-0419_112204_gc30_D_1_Sd_mc': ['1 M sucrose', X, 'b'], 
'2011-0511_112204_gc30_G_1_2Sd_mc' :['2 M sucrose', Y, 'k'], 
'2011-1109_112204_gc30_D_1_Cd_mc': ['100 mM caffeine', Z, 'k']}
...
withleg='no'):
    ...
    for k, v in moviedict.iteritems():
        ...
        if movie == '2011-1109_112204_gc30_C_1_Cd_mc':
