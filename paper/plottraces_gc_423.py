...
#MOVIES = {'2011-1107_423_gc30_C_1_Wd_mc': ['Water', W, 'k'], '2011-0718_423_gc30_A_1_Sd_mc': ['1 M sucrose', 
#X, 'b'], '2011-0722_423_gc30_D_1_2Sd_mc' :['2 M sucrose', Y, 'k'], '2011-1112_423_gc30_C_1_Cd_mc': 
#['100 mM caffeine', Z, 'k']}
...
withleg='no'):
    ...
    plt.text(linex+1.5, liney-0.1, ' 3s', fontproperties=fontv, horizontalalignment='center', verticalalignment='top',multialignment='center',rotation=0)
